...
class gemsUpdate(sublime_plugin.WindowCommand):
	def run(self):
		...
		if sublime.ok_cancel_dialog("Current version is {}. Click OK to update.".format(version)):
			...
			urllib.request.urlretrieve("https://raw.githubusercontent.com/vtphan/GEM/simple/src/GEMStudent/GEMStudent.py", module_file)
			urllib.request.urlretrieve("https://raw.githubusercontent.com/vtphan/GEM/simple/src/GEMStudent/Main.sublime-menu", menu_file)
