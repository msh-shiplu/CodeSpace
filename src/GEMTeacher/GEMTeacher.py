...
class gemtUpdate(sublime_plugin.WindowCommand):
	def run(self):
		...
		if sublime.ok_cancel_dialog("Current version is {}. Click OK to update.".format(version)):
			...
			urllib.request.urlretrieve("https://raw.githubusercontent.com/vtphan/GEM/simple/src/GEMTeacher/GEMTeacher.py", module_file)
			urllib.request.urlretrieve("https://raw.githubusercontent.com/vtphan/GEM/simple/src/GEMTeacher/Main.sublime-menu", menu_file)
			urllib.request.urlretrieve("https://raw.githubusercontent.com/vtphan/GEM/simple/src/version.go", version_file)
