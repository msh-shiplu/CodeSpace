...
class gemaUpdate(sublime_plugin.WindowCommand):
	def run(self):
		...
		if sublime.ok_cancel_dialog("Current version is {}. Click OK to update.".format(version)):
			...
			urllib.request.urlretrieve("https://raw.githubusercontent.com/vtphan/GEM/alina/src/GEMAssistant/GEMAssistant.py", module_file)
			urllib.request.urlretrieve("https://raw.githubusercontent.com/vtphan/GEM/alina/src/GEMAssistant/Main.sublime-menu", menu_file)
			urllib.request.urlretrieve("https://raw.githubusercontent.com/vtphan/GEM/alina/src/GEMAssistant/Default.sublime-keymap", keymap_file)
